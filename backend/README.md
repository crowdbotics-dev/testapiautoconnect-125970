...
## Project Structure
    ...
    ├── testapiautoconnect_125970  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_125970`
...
2. Clone this repo and `cd testapiautoconnect_125970`
